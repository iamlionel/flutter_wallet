...
mixin _$AuthLandingState {
 ...
 String get password; String get errorMessage; bool get isValid; Wallet get wallet; AuthLandingStatus get status;
...
@useResult
$Res call({
 String password, String errorMessage, bool isValid, Wallet wallet, AuthLandingStatus status
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String password,  String errorMessage,  bool isValid,  Wallet wallet,  AuthLandingStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthLandingState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String password,  String errorMessage,  bool isValid,  Wallet wallet,  AuthLandingStatus status)  $default,) {final _that = this;
switch (_that) {
case _AuthLandingState():
return $default(_that.password,_that.errorMessage,_that.isValid,_that.wallet,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String password,  String errorMessage,  bool isValid,  Wallet wallet,  AuthLandingStatus status)?  $default,) {final _that = this;
switch (_that) {
case _AuthLandingState() when $default != null:
return $default(_that.password,_that.errorMessage,_that.isValid,_that.wallet,_that.status);case _:
  return null;
...
class _AuthLandingState implements AuthLandingState {
  const _AuthLandingState({this.password = '', this.errorMessage = '', this.isValid = false, this.wallet = const Wallet(), this.status = AuthLandingStatus.initial});
