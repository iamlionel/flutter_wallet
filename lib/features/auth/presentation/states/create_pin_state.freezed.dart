...
mixin _$CreatePinState {
 ...
 String get password; String get confirmPassword; bool get isValid; CreatePinStatus get status; Wallet get wallet;
...
@useResult
$Res call({
 String password, String confirmPassword, bool isValid, CreatePinStatus status, Wallet wallet
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String password,  String confirmPassword,  bool isValid,  CreatePinStatus status,  Wallet wallet)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreatePinState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String password,  String confirmPassword,  bool isValid,  CreatePinStatus status,  Wallet wallet)  $default,) {final _that = this;
switch (_that) {
case _CreatePinState():
return $default(_that.password,_that.confirmPassword,_that.isValid,_that.status,_that.wallet);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String password,  String confirmPassword,  bool isValid,  CreatePinStatus status,  Wallet wallet)?  $default,) {final _that = this;
switch (_that) {
case _CreatePinState() when $default != null:
return $default(_that.password,_that.confirmPassword,_that.isValid,_that.status,_that.wallet);case _:
  return null;
...
class _CreatePinState implements CreatePinState {
  const _CreatePinState({this.password = '', this.confirmPassword = '', this.isValid = false, this.status = CreatePinStatus.initial, this.wallet = const Wallet()});
