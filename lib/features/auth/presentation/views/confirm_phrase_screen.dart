...
import '../viewmodels/seed_phrase_viewmodel.dart';

import '../../../../core/router/routes.dart';
import '../../../../core/ui/themes/colors.dart';
import '../../../../core/utils/extensions.dart';
import 'mnemonics_chip.dart';
...
class _ConfirmPhraseScreenState extends ConsumerState<ConfirmPhraseScreen> {
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(seedPhraseViewModelProvider);
    final notifier = ref.read(seedPhraseViewModelProvider.notifier);
    final theme = Theme.of(context);

    ref.listen<SeedPhraseState>(seedPhraseViewModelProvider, (previous, next) {
