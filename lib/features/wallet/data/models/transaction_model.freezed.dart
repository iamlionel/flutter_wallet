...
mixin _$TransactionModel {
 ...
 String get hash; String get from; String get to; String get value; String get timeStamp;// unix timestamp string from Etherscan
 String get isError;// "0" = success, "1" = failed
 String get tokenSymbol; String get tokenDecimal; bool get isErc20; String get chain;
...
class _TransactionModel extends TransactionModel {
  const _TransactionModel({required this.hash, required this.from, required this.to, required this.value, required this.timeStamp, required this.isError, this.tokenSymbol = '', this.tokenDecimal = '', this.isErc20 = false, this.chain = 'eth'}): super._();
...
// unix timestamp string from Etherscan
