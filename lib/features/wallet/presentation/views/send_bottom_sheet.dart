...
final _gasPriceProvider = FutureProvider.autoDispose<double>((ref) async {
  final evm = await ref.watch(evmAdapterProvider.future);
  final gasPrice = await evm.getGasPrice();
...
class _SendBottomSheetState extends ConsumerState<SendBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final walletState = ref.watch(appViewModelProvider);
